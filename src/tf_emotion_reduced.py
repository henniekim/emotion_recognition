# Reduced AlexNet : Hidden Layer 2

# Accuracy Data
# Batch 256, Epoch 500, Weight 0.01 , Bias 0.01 -> 63.46 % // 2018.01.10
...
f_acc = io.open("test_accuracy__reduced_graph.txt", "w", encoding="utf8")
test_acc = list()
...
for i in range(epoch):
    ...
    np.savetxt('test_accuracy_graph.txt', np.array(test_acc), fmt='%.2f', delimiter='\t')
